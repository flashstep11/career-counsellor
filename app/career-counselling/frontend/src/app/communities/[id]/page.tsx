...
export default function CommunityDetailPage() {
    ...
    useEffect(() => {
        ...
        const offRoleUpdate = onEvent("community_role_update", (data: { communityId: string; userId: string; role: string }) => {
            setCommunity((prev) => {
                if (!prev || prev.communityId !== data.communityId) return prev;
                const nextRoles = { ...(prev.community_roles ?? {}) };
                if (data.role === "moderator") {
                    nextRoles[data.userId] = "moderator";
                } else {
                    delete nextRoles[data.userId];
                }
                if (data.userId === userId) {
                    return {
                        ...prev,
                        community_roles: nextRoles,
                ...
                prev
                    ? (() => {
                        ...
                        return {
                            ...
                            isModerator: prev.isJoined ? false : prev.isModerator,
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50/30">
            ...
            <div className="w-full px-6 sm:px-8 lg:px-12 -mt-6">
                        ...
                        {loadingCommunity ? (
                            ...
                            <>
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 shrink-0">
                                    {isAuthenticated && community?.createdBy === userId && community?.isModerator && (
