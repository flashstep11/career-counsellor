...
import { TrendingUp, History, Play, LogIn, UserPlus, X } from "lucide-react";
import {
  Pagination,
  PaginationContent,
  PaginationItem,
...
export default function VideosPage() {
  ...
  const handleRequireLogin = useCallback((e?: React.MouseEvent) => {
    e?.preventDefault();
  ...
  return (
    <div className="container mx-auto px-4 pt-2 pb-8">
      ...
      <AuthRequiredOverlay
        ...
        description="Sign in to watch videos, save progress, and unlock the full learning experience."
      />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {videos.map((video) => (
                    <VideoCard
                      key={video.videoID}
                      video={video}
                      blockNavigation={!isAuthenticated}
