                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (otpSent && !otpVerified) {
                          handleVerifyOtp(form.watch("email"));
                        } else {
                          handleSendOtp(form.watch("email"));
                        }
                      }}
                      disabled={sendingOtp || verifyingOtp || otpVerified || !form.watch("email")}
                      className="shrink-0"
                    >
                  ...
                  {otpSent && !otpVerified && (
                    <div className="flex justify-center">
                      <button
                        ...
                        disabled={sendingOtp || !form.watch("email")}
                        className="text-xs text-primary-blue hover:underline disabled:opacity-60"
                      >
                        Resend OTP
                      </button>
                    </div>
