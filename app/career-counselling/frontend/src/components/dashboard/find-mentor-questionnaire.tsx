              ...
              >
                {question.options?.map((option) => (
                  <Label
                    key={option}
                    htmlFor={option}
                    className={`flex items-center space-x-3 p-4 border-2 rounded-lg hover:border-blue-300 hover:bg-blue-50/50 transition-all cursor-pointer ${answers[question.id] === option ? "border-blue-500 bg-blue-50" : "border-gray-200"
                      }`}
                  >
                ...
                {question.options?.map((option) => {
                  ...
                  return (
                    <Label
                      key={option}
                      htmlFor={option}
                      className={`flex items-center space-x-3 p-4 border-2 rounded-lg hover:border-blue-300 hover:bg-blue-50/50 transition-all cursor-pointer ${isChecked ? "border-blue-500 bg-blue-50" : "border-gray-200"
                        }`}
                    >
                      <Checkbox
                        id={option}
